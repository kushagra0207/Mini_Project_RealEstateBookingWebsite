    ...
    return (
        <>
            ...
            <div className="grid grid-cols-3 gap-5 mx-8 pt-8">
                <div className="columns-1 col-span-2 bg-transparent rounded-xl p-4 bg-opacity-40 mt-[5rem]">
                    <LoginPagePara/>
                </div>
                <div
                    className="columns-1 bg-sky-800 rounded-xl px-4 bg-opacity-40 mt-[7rem]"
                    role="navigation"
                >
